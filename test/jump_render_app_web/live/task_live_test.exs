defmodule JumpRenderAppWeb.TaskLiveTest do
  use JumpRenderAppWeb.ConnCase

  import Phoenix.LiveViewTest
  import JumpRenderApp.TasksFixtures

  @create_attrs %{title: "some title", due_date: "2025-04-15", completed: true}
  @update_attrs %{title: "some updated title", due_date: "2025-04-16", completed: false}
  @invalid_attrs %{title: nil, due_date: nil, completed: false}
